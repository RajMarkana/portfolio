...
const Team = () => {
    return (
        <>
            <h2 className="text-3xl font-bold  p-6 text-center" id='team'>Our Team</h2>
            <br />
            <section className='flex justify-center flex-wrap gap-8 '>

                <div className="flex flex-col justify-center max-w-xs p-6 rounded-xl sm:px-12 dark:bg-gray-900 dark:text-gray-100 w-fit">
